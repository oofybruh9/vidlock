...
<body>
    <section id="tl-dr" aria-labelledby="tldr-title">
        ...
        <div class="grid">
            <div class="callout">
                <strong>Privacy:</strong> we collect the basics (account, uploads, usage). We use it to run the site and
    ...
    <section id="privacy" aria-labelledby="privacy-title">
        ...
        <h2 id="2-what-we-do-with-it">2. What We Do With It</h2>
        <ul>
            <li>Show you cool stuff you might like.</li>
            <li>Let other people see your videos and (hopefully) lock in.</li>
            <li>Keep the trolls away (well, we try).</li>
        </ul>
        ...
        <h2 id="5-your-powers">5. Your Powers</h2>
        <ul>
            <li>Change your username to something cooler.</li>
            <li>Switch between light and dark mode like a true gamer.</li>
            <li>Nuke your account from orbit if you want to disappear <em><strong>FOREVER</strong></em>.</li>
        </ul>
        <hr>
