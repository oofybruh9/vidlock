...
<ul>
  <li><strong>Account information:</strong> username, email address, password (stored securely).</li>
  <li><strong>Content you upload:</strong> videos, thumbnails, comments, profile data.</li>
  <li><strong>Usage data:</strong> pages visited, search queries, watch history.</li>
...
<ul>
  ...
  <li>We may share data only with:
    <ul>
...
<ul>
  ...
  <li>Change your theme, username, or password.</li>
  <li>Request removal of your data by contacting support.</li>
</ul>

<h2>6. Security</h2>
<p>We use encryption, secure passwords, and other measures to protect your data, but no system is 100% secure.</p>

<h2>7. Changes</h2>
<p>We may update this policy from time to time. Significant changes will be announced on the site.</p>
...
<ul>
  ...
  <li>You may not impersonate others or use offensive usernames.</li>
</ul>
...
<ul>
  ...
  <li>You may not upload:
    <ul>
      ...
      <li>Violence, hate speech, or dangerous content.</li>
...
<ul>
  <li>Subscriptions are free unless otherwise stated.</li>
  <li>We may remove subscribers or channels violating the Terms.</li>
</ul>
